...
export default class AccountSettingsController {
  ...
  static async registerCompany(req, res) {
    ...
    const { name, website, email, phone, industry, size, address, description } = req.body || {};
...
//       const profile = {
//         name: user.name,
//         headline: 'Full Stack Developer | Node.js | Flutter',
//         bio: 'Passionate developer building scalable web and mobile apps.',
...
//           company: 'TechNova',
//           startDate: '2024',
//           description: 'Building full-stack applications using Node.js and React.',
//         },
...
//             company: 'CloudSync',
//             duration: '2023 - 2024',
//             description: 'Worked on REST APIs and real-time systems.',
//           },
//         ],
...
//         skills: ['Node.js', 'Express', 'MongoDB', 'Socket.IO', 'Flutter'],
//       };
